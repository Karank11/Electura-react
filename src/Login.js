...
import "./Login.css";
import log from "../src/images/log1.png"
import { NavLink } from 'react-router-dom';
const Login = ()=>{
    return(
            <Form className="login-form">
                <div className="col-lg-6 order-1 order-lg-2 header-img text-center">
                    <img src={log} className="img-fluid animated text-center ml-5" alt="home img" />
                </div>
                ...
                <div className="text-center">
                   <NavLink to="/register" className="nav-link font-weight-bold">Register Here</NavLink> 
                </div>
            </Form>       
    );
};
